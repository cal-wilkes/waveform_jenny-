...
##set_property PACKAGE_PIN R2 [get_ports {switch_pin}]					
	##set_property IOSTANDARD LVCMOS33 [get_ports {switch_pin}]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {JENNY}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JENNY}]
##Sch name = JB2
